<?php
namespace hzted123\taobaosdk\top\security;
use \Exception;
use vendor\hzted123\taobaosdk\top\security\SecretData;
...
class SecurityUtil
{
    ...
    */
     ...
     * @return string
     * @internal param $encryptText 被签名的字符串*            被签名的字符串
     * @internal param $encryptKey 密钥*            密钥
     * @internal param $compressLen压缩长度
     */
    ...
    function encryptPhoneIndex($data, $separator, $secretContext)
    {
        ...
        return $separator . $this->hmacMD5EncryptToBase64($last4Number, $secretContext->secret) . $separator . Security::encrypt($data,
                $secretContext->secret) . $separator . $secretContext->secretVersion . $separator . $separator;
    }
