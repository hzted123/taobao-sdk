...
class SecurityClient
{
     ...
     * @return string
     * @throws \Exception
     * @internal param $data 明文数据*            明文数据
     * @internal param $type 加密字段类型(例如：simple\phone)*            加密字段类型(例如：simple\phone)
     * @internal param $session 用户身份,用户级加密必填*            用户身份,用户级加密必填
     * @internal param $version 秘钥历史版本*            秘钥历史版本
     */
     ...
     *
     * @param $session
     * @return \hzted123\taobaosdk\top\security\SecretContext
     * @throws \Exception
     */
